...
**[github.com/UjjwalSud/clean-architecture-10.0](https://github.com/DheerajKumar602/clean-architecture-10.0)**
...
| Repository | Role |
|------------|------|
| [clean-architecture-10.0](https://github.com/DheerajKumar602/clean-architecture-10.0) | **Architecture source** — the .NET API and React SPA this showcase documents |
| [ai-engineering-system](https://github.com/DheerajKumar602/ai-engineering-system) | **Reusable AI engineering system** — rules, prompts, stack guidance, planning conventions, and workflow patterns applied across projects |
| [clean-architecture-10.0-showcase](https://github.com/DheerajKumar602/clean-architecture-10.0-showcase) | **This repository** — public explanation, diagrams, and UI evidence |
