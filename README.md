...
| Repository | Role |
|------------|------|
| [ai-engineering-system](https://github.com/DheerajKumar602/ai-engineering-system) | Public reusable AI-assisted engineering system — rules, prompts, stack guidance, planning conventions, and workflow patterns |
| [clean-architecture-10.0-showcase](https://github.com/DheerajKumar602/clean-architecture-10.0-showcase) | This public showcase — architecture explanation, diagrams, and UI evidence |
...
If you're building a .NET/React application and are interested in using this architecture as a foundation, feel free to reach out through my [GitHub profile](https://github.com/DheerajKumar602).
